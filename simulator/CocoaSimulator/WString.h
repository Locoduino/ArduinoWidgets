...
public:
	...
	String(size_t, unsigned char base=10);
//--- Commented out by PM
...
//--- Added by PM
  String(float num) ;
	...
	String & copy(const __FlashStringHelper *s) { return copy((const char *)s, (unsigned) strlen((const char *)s)); }
	...
	String & append(const __FlashStringHelper *s)	{return append((const char *)s, (unsigned) strlen((const char *)s)); }
